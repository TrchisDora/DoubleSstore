					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> 0788781116 </a></li>
								<li><a href="#"><i class="fa fa-envelope"></i>  vithanhnga2015123@gmail.com </a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="social-icons pull-right">
							<ul class="nav navbar-nav">
								<li><a href="https://www.facebook.com/TrChisnguyen1807"><i class="fa fa-facebook"></i></a></li>								
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="index.html"><img src="{{('public/fontend/images/home/logo_header.jpg')}}" alt="" /></a>
						</div>
					</div>
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								?>
									<li><a href="{{URL::to('/checkout')}}"><i class="fa fa-crosshairs"></i> Kiểm tra đơn hàng</a></li>
								<?php
								}elseif($customer_id!=NULL && $shipping_id!=NULL){
								?>
									<li><a href="{{URL::to('/payment')}}"><i class="fa fa-crosshairs"></i> Kiểm tra đơn hàng</a></li>
								<?php
								}else{
								?>
								<li><a href="{{URL::to('/login-checkout')}}"><i class="fa fa-crosshairs"></i> Kiểm tra đơn hàng</a></li>
								<?php
								}
								?>
					...
					<div class="col-sm-7">
						...
						<div class="mainmenu pull-left">
							...
							<li><a href="{{ URL::to('/trang-chu') }}" class="active">Trang chủ</a></li>
								<li class="dropdown"><a href="{{ URL::to('/DS') }}">Sản phẩm<i class="fa fa-angle-down"></i></a>
