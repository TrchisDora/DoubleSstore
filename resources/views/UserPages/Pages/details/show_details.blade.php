...
<div class="product-details">
        ...
        <div id="similar-product" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    <a href="#"><img src="{{ URL::to('/public/fontend/images/product-details/similar1.jpg') }}" alt=""></a>
    ...
    <div class="col-sm-7">
        <div class="product-information"><!--product_information-->
            ...
            <form action="{{URL::to('/save-car')}}" method="POST">
                {{ csrf_field() }}
            <span>
                <span>{{number_format($value->product_price).'VNĐ'}}</span>
                <label>Số lượng: {{$value->product_quantity}}</label>
...
<div class="tab-content">
    ...
    <div class="tab-pane fade" id="reviews">
        <div class="col-sm-12">
            ...
            <p>Nhân đẹp zai mời bạn cho reviews về sản phẩm của chúng tôi</p>
